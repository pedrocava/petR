...
* Gere um DataFrame que é uma "grade" 100x100. Você terá então um DataFrame com 100*100 linhas e duas colunas, cada uma representando uma coordenada de um espaço de duas dimensões. Mais explicitamente, a primeira coluna terá cem vezes o número 1, cem vezes o número 2 e assim em diante, com a segunda tendo cem vezes a sequência de 1 a 100.
